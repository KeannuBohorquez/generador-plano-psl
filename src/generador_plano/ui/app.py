# =============================================================
#  ui/app.py — Ventana principal de la aplicacion
# =============================================================
...
from .widgets import (
    ...
    FONT_BOLD, FONT_LABEL, FONT_MONO, FONT_BTN, FONT_TITLE,
)
...
from ..config import NOMBRES_MES_LARGO, NOMBRES_MES_CORTO
...
class App(tk.Tk):
    """Ventana principal del Generador de Archivo Plano PSL."""

    def __init__(self) -> None:
        super().__init__()
        self.title("Generador Archivo Plano PSL - Toledana del Sur")
        ...
        sys.stdout = LogRedirect(self._log, "dim")
        sys.stderr = LogRedirect(self._log, "err")
    ...
    def _build_ui(self) -> None:
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="Generador Archivo Plano PSL",
                 font=FONT_TITLE, bg=COLOR_BLUE, fg="white").pack()
        tk.Label(hdr, text="P.A. Toledana del Sur  -  Conciliacion BanColombia",
                 font=("Segoe UI", 9), bg=COLOR_BLUE, fg="#A8C4E0").pack()
    ...
    def _build_form(self, body: tk.Frame) -> None:
        ...
        ttk.Combobox(rp, textvariable=self.mes_var, values=MESES,
        ...
        tk.Spinbox(rp, from_=2020, to=2040, textvariable=self.anio_var,
        ...
        self.pwd_pdf = tk.Entry(grid, show="*", font=FONT_LABEL, width=20, relief="flat",
        ...
        self.pwd_xls = tk.Entry(grid, show="*", font=FONT_LABEL, width=20, relief="flat",
                                highlightthickness=1, highlightbackground=COLOR_BORDER, bg="#F8FAFC")
        self.pwd_xls.grid(row=0, column=3, sticky="w", padx=(8, 0), ipady=4)

        self.show_pwd = tk.BooleanVar()
        tk.Checkbutton(grid, text="Mostrar contrasenas", variable=self.show_pwd,
        ...
        self.n_comp = tk.Entry(grid, font=FONT_LABEL, width=20, relief="flat",
                               highlightthickness=1, highlightbackground=COLOR_BORDER, bg="#F8FAFC")
        ...
        self.log = tk.Text(log_frame, height=14, font=FONT_MONO,
